...
declare class Class_Redis extends Class_object {
     ...
     */
    set(key: Class_Buffer, value: Class_Buffer, ttl?: number | bigint): void;
     ...
     *      @param ttl 以毫秒为单位为 key 设置生存时间；如果 ttl 为 0 ，那么不设置生存时间 
     */
    setNX(key: Class_Buffer, value: Class_Buffer, ttl?: number | bigint): void;
     ...
     *      @param ttl 以毫秒为单位为 key 设置生存时间；如果 ttl 为 0 ，那么不设置生存时间 
     */
    setXX(key: Class_Buffer, value: Class_Buffer, ttl?: number | bigint): void;
     ...
     */
    decr(key: Class_Buffer, num?: number | bigint): bigint;
     ...
     */
    incr(key: Class_Buffer, num?: number | bigint): bigint;
     ...
     *      @return 若 key 存在，返回 True，否则返回 False 
     */
    expire(key: Class_Buffer, ttl: number | bigint): boolean;
     ...
     *      @param ttl 以毫秒为单位为 key 设置生存时间；如果 ttl 为 0 ，那么不设置生存时间
     */
    restore(key: Class_Buffer, data: Class_Buffer, ttl?: number | bigint): void;
