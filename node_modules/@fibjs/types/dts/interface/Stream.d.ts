...
declare class Class_Stream extends Class_object {
     ...
     *      
     */
    copyTo(stm: Class_Stream, bytes?: number | bigint): bigint;

    copyTo(stm: Class_Stream, bytes?: number | bigint, callback?: (err: Error | undefined | null, retVal: bigint)=>any): void;
