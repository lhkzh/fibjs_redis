...
declare module 'io' {
     ...
     *      
     */
    function copyStream(from: Class_Stream, to: Class_Stream, bytes?: number | bigint): bigint;

    function copyStream(from: Class_Stream, to: Class_Stream, bytes?: number | bigint, callback?: (err: Error | undefined | null, retVal: bigint)=>any): void;
