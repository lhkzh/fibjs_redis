...
exports.encodeMultCommand = exports.encodeCommand = exports.RedisError = exports.Redis = exports.RedisEvent = void 0;
/**
 * redis-客户端类
 */
...
class Redis extends events_1.EventEmitter {
    ...
    _on_open_fail(e) {
        this._onOpen.pulse();
        this.emit(exports.RedisEvent.onError, "io_error");
    }
    /**
    ...
    _on_err(e, deadErr) {
        ...
        this.emit(exports.RedisEvent.onError, String(e));
    }
    ...
    xReadGroup(group, consumer, streamOptions, count, blockMillon) {
    ...
    xRead(keyIds, count, blockMillon) {
        let args = [CmdXREAD];
        if (Number.isInteger(blockMillon)) {
            args.push("BLOCK", blockMillon);
            this._pre_block();
